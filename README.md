...
CerebroNexus is a [Shiny](https://shiny.posit.co/) platform for exploring and sharing single-cell and spatial transcriptomics data, with gene-expression, immune-repertoire, trajectory, and HLA-TCR analyses. See the [full documentation](https://www.mheming.com/CerebroNexus/).
...
![CerebroNexus spatial data view](https://raw.githubusercontent.com/mihem/CerebroNexus/master/man/figures/featured.png)
