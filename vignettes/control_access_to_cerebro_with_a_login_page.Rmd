...
The runtime account needs write access to `private-data/auth/` because SQLite
may create login-state sidecars.
...
the container environment without copying the file into the image.
