...
sce@metadata$technical_info <- list(
  ...
  'scran' = utils::packageVersion('scran'),
  'scater' = utils::packageVersion('scater'),
...
```{r marker_genes_clusters, eval=FALSE}
...
```{r marker_genes_cell_types, eval=FALSE}
