...
Measurements ran on Linux with an Intel Core i7-14700, 28 logical cores, 128 GB RAM, R 4.6.1, and CerebroNexus 3.2.0. Source files totalled 54.5 GB and are pinned by SHA-256 in the run's [`source_manifest.csv`](https://github.com/mihem/CerebroNexus/blob/master/tools/bench/result/runs/20260805T214336Z-02ff3f0a971e-publication/source_manifest.csv).
...
![Six complementary views of export, storage, startup, memory, single-gene access, and materialized block access. Points show medians; the generated report retains observed ranges.](figures/expression_backend_benchmark/expression_backend_benchmark_overview.png)

## Complete measured comparison

This compact table keeps all four tested source/tier points and all three backends together. The immutable [`summary.md`](https://github.com/mihem/CerebroNexus/blob/master/tools/bench/result/runs/20260805T214336Z-02ff3f0a971e-publication/summary.md) additionally reports the observed minimum and maximum for every median.

| Data point | Backend | Export s | Stored MB | Ready s | RSS MB | Warmed gene s | 12-gene block s |
|---|---|---:|---:|---:|---:|---:|---:|
| Human PFC · HBCC · 50k | `embedded` | 97.0 | 527.9 | 7.09 | 2,725 | 0.329 | 0.343 |
| Human PFC · HBCC · 50k | `bpcells` | 6.5 | 334.5 | 1.25 | 420 | 0.369 | 0.383 |
| Human PFC · HBCC · 50k | `h5` | 88.0 | 268.7 | 2.40 | 527 | 0.005 | 0.047 |
| Human PFC · MSSM · 50k | `embedded` | 84.2 | 459.1 | 6.27 | 2,429 | 0.283 | 0.299 |
| Human PFC · MSSM · 50k | `bpcells` | 6.0 | 291.7 | 1.25 | 419 | 0.326 | 0.339 |
| Human PFC · MSSM · 50k | `h5` | 78.5 | 240.5 | 2.40 | 527 | 0.005 | 0.047 |
| Mouse E18 · 50k | `embedded` | 38.5 | 210.0 | 3.36 | 1,444 | 0.155 | 0.170 |
| Mouse E18 · 50k | `bpcells` | 4.1 | 176.6 | 1.24 | 416 | 0.192 | 0.208 |
| Mouse E18 · 50k | `h5` | 38.0 | 117.3 | 2.38 | 529 | 0.005 | 0.050 |
| Mouse E18 · 150k | `embedded` | 118.4 | 637.4 | 9.63 | 3,755 | 0.470 | 0.509 |
| Mouse E18 · 150k | `bpcells` | 11.1 | 535.2 | 1.56 | 470 | 0.571 | 0.626 |
| Mouse E18 · 150k | `h5` | 156.2 | 350.3 | 2.42 | 550 | 0.013 | 0.332 |
...
![Order-balanced export repeats. Each grey path is one repeat and the backend order rotates.](figures/expression_backend_benchmark/expression_backend_benchmark_repeats.png)
...
![Fresh-process and warmed query latency, including dense materialization for the 12-gene block.](figures/expression_backend_benchmark/expression_backend_benchmark_query_latency.png)
...
![Storage-memory Pareto view. Lower-left combines smaller bundles with lower runtime RSS.](figures/expression_backend_benchmark/expression_backend_benchmark_pareto.png)
...
![Observed export-memory scaling for successful runs. The lines do not extrapolate a capacity boundary.](figures/expression_backend_benchmark/expression_backend_benchmark_observed_scaling.png)
...
![Correctness audit: all six access processes for every source, tier, and backend matched both source fingerprints.](figures/expression_backend_benchmark/expression_backend_benchmark_correctness.png)
...
- [`05_schedule.csv`](https://github.com/mihem/CerebroNexus/blob/master/tools/bench/result/runs/20260805T214336Z-02ff3f0a971e-publication/05_schedule.csv): requested source, tier, backend, repeat, and order position;
- [`resource_check.csv`](https://github.com/mihem/CerebroNexus/blob/master/tools/bench/result/runs/20260805T214336Z-02ff3f0a971e-publication/resource_check.csv): pre-download memory, index, and disk gate;
- [`10_export.csv`](https://github.com/mihem/CerebroNexus/blob/master/tools/bench/result/runs/20260805T214336Z-02ff3f0a971e-publication/10_export.csv): 36 raw export-process rows;
- [`20_access.csv`](https://github.com/mihem/CerebroNexus/blob/master/tools/bench/result/runs/20260805T214336Z-02ff3f0a971e-publication/20_access.csv): 72 raw access-process rows and fingerprints;
- [`run_manifest.csv`](https://github.com/mihem/CerebroNexus/blob/master/tools/bench/result/runs/20260805T214336Z-02ff3f0a971e-publication/run_manifest.csv): exact Git, dependency-environment, package, R, OS, CPU, and memory provenance.

To reproduce or adapt the protocol, start with the repository-only [`tools/bench/README.md`](https://github.com/mihem/CerebroNexus/blob/master/tools/bench/README.md) and [`METHODOLOGY.md`](https://github.com/mihem/CerebroNexus/blob/master/tools/bench/METHODOLOGY.md). The harness performs resource preflight before downloading complete matrices and publishes a run only after measurement, report, and figure validation.
