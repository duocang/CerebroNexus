...
estimated_capacity_nnz <- limit_mb * 2^20 / bytes_per_nnz
...
capacity_estimate <- ggplot(
  ...
  geom_vline(
    xintercept = estimated_capacity_nnz,
    colour = "grey55",
    linewidth = 0.4
  ) +
...
ggsave(
  file.path(out_dir, "expression_backend_benchmark_capacity_estimate.png"),
  capacity_estimate,
  width = 8,
  height = 4.4,
  dpi = 150,
