# Guards for the pure planning/ordering logic in tools/bench/lib/remote_h5.R.
#
# Only the functions that need no network are exercised here.

bench_lib <- file.path("..", "..", "lib", "remote_h5.R")
