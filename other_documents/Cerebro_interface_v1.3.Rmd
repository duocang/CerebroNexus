...
Use **Download PNG** in the plot toolbar to save the current view directly. If the current view supports portable sharing, you can instead open **Share view** and select **Download PNG** there. Share view also provides a portable JSON configuration containing the current display state and selected cell barcodes, which can be opened in another compatible CerebroNexus session without including the source data.
