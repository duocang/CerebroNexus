...
#> [19:35:56] Loading gene sets...
#> [19:35:56] Loaded 2 gene sets from GMT file.
#> [19:35:56] Extracting transcript counts from `data` slot of `RNA` assay...
#> [19:35:56] Performing analysis for 2 subgroups of group `sample`...
...
#> [19:35:56] 0 gene sets passed the thresholds across all subgroups of group `sample`.
#> [19:35:56] Performing analysis for 2 subgroups of group `seurat_clusters`...
#> ℹ GSVA version 2.6.5
#> ℹ Searching for rows with constant values
#> ℹ Calculating GSVA ranks
#> ℹ kcdf='auto' (default)
...
#> ℹ Calculating GSVA scores for 2 gene sets
#> ✔ Calculations finished
#> [19:35:57] 0 gene sets passed the thresholds across all subgroups of group `seurat_clusters`.
```
