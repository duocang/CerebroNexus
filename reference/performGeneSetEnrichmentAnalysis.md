...
#> [10:12:22] Loading gene sets...
#> [10:12:22] Loaded 2 gene sets from GMT file.
#> [10:12:22] Extracting transcript counts from `data` slot of `RNA` assay...
#> [10:12:22] Performing analysis for 2 subgroups of group `sample`...
...
#> [10:12:22] 0 gene sets passed the thresholds across all subgroups of group `sample`.
#> [10:12:22] Performing analysis for 2 subgroups of group `seurat_clusters`...
#> ℹ GSVA version 2.6.2
#> ℹ Searching for rows with constant values
#> ℹ Calculating GSVA ranks
#> ℹ kcdf='auto' (default)
...
#> ℹ Calculating GSVA scores for 2 gene sets
#> ✔ Calculations finished
#> [10:12:22] 0 gene sets passed the thresholds across all subgroups of group `seurat_clusters`.
```
