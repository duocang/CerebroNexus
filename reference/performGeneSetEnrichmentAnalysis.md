...
#> [09:41:26] Loading gene sets...
#> [09:41:26] Loaded 2 gene sets from GMT file.
#> [09:41:26] Extracting transcript counts from `data` slot of `RNA` assay...
#> [09:41:26] Performing analysis for 2 subgroups of group `sample`...
...
#> [09:41:27] 0 gene sets passed the thresholds across all subgroups of group `sample`.
#> [09:41:27] Performing analysis for 2 subgroups of group `seurat_clusters`...
#> ℹ GSVA version 2.6.2
#> ℹ Searching for rows with constant values
#> ℹ Calculating GSVA ranks
#> ℹ kcdf='auto' (default)
...
#> ℹ Calculating GSVA scores for 2 gene sets
#> ✔ Calculations finished
#> [09:41:27] 0 gene sets passed the thresholds across all subgroups of group `seurat_clusters`.
```
