...
#> [14:13:18] Loading gene sets...
#> [14:13:18] Loaded 2 gene sets from GMT file.
#> [14:13:18] Extracting transcript counts from `data` slot of `RNA` assay...
#> [14:13:18] Performing analysis for 2 subgroups of group `sample`...
...
#> [14:13:18] 0 gene sets passed the thresholds across all subgroups of group `sample`.
#> [14:13:18] Performing analysis for 2 subgroups of group `seurat_clusters`...
#> ℹ GSVA version 2.6.6
#> ℹ Searching for rows with constant values
#> ℹ Calculating GSVA ranks
#> ℹ kcdf='auto' (default)
...
#> ℹ Calculating GSVA scores for 2 gene sets
#> ✔ Calculations finished
#> [14:13:18] 0 gene sets passed the thresholds across all subgroups of group `seurat_clusters`.
```
