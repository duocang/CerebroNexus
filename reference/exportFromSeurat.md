...
#> [11:53:37] Initializing Cerebro object...
#> [11:53:37] Adding expression data (embedded)...
#> [11:53:37] Collecting available meta data...
#> [11:53:37] Extracting all meta data columns...
#> [11:53:37] Extracting dimensional reductions...
#> [11:53:37] Will export the following dimensional reductions: umap
#> [11:53:37] Extracting marker genes table...
#> [11:53:37] No trajectories to extract...
#> [11:53:37] Checking for spatial data...
#> [11:53:37] Overview of Cerebro object:
#> class: Cerebro
#> exporter package version: 5.0.0
#> experiment name: PBMC
#> organism: hg
#> date of analysis: 
#> date of export: 2026-08-15
#> number of cells: 80
#> number of genes: 230
...
#> HLA typing: none
#> Spatial data:
#> [11:53:37] Saving Cerebro object to: /tmp/nix-shell-4424-1141775333/Rtmp2eR7wM/pbmc_Seurat.crb
#> [11:53:37] Done!
```
