...
#> [22:20:48] Initializing Cerebro object...
#> [22:20:48] Adding expression data (embedded)...
#> [22:20:48] Collecting available meta data...
#> [22:20:48] Extracting all meta data columns...
#> [22:20:48] Extracting dimensional reductions...
#> [22:20:48] Will export the following dimensional reductions: umap
#> [22:20:48] Extracting marker genes table...
#> [22:20:48] No trajectories to extract...
#> [22:20:48] Checking for spatial data...
#> [22:20:48] Overview of Cerebro object:
#> class: Cerebro
#> exporter package version: 4.3.4
#> experiment name: PBMC
#> organism: hg
#> date of analysis: 
#> date of export: 2026-08-31
#> number of cells: 80
#> number of genes: 230
...
#> HLA typing: none
#> Spatial data:
#> [22:20:48] Saving Cerebro object to: /tmp/nix-shell-4387-2626959977/RtmpVuprnP/pbmc_Seurat.crb
#> [22:20:48] Done!
```
