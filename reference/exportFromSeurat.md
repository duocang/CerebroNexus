...
#> [23:18:27] Initializing Cerebro object...
#> [23:18:27] Adding expression data (embedded)...
#> [23:18:27] Collecting available meta data...
#> [23:18:27] Extracting all meta data columns...
#> [23:18:27] Extracting dimensional reductions...
#> [23:18:27] Will export the following dimensional reductions: umap
#> [23:18:27] Extracting marker genes table...
#> [23:18:27] No trajectories to extract...
#> [23:18:27] Checking for spatial data...
#> [23:18:27] Overview of Cerebro object:
#> class: Cerebro
#> exporter package version: 5.0.0
#> experiment name: PBMC
#> organism: hg
#> date of analysis: 
#> date of export: 2026-08-18
#> number of cells: 80
#> number of genes: 230
...
#> HLA typing: none
#> Spatial data:
#> [23:18:28] Saving Cerebro object to: /tmp/nix-shell-4439-1136062483/RtmpslfXjY/pbmc_Seurat.crb
#> [23:18:28] Done!
```
