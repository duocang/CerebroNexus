...
#> [14:59:21] Initializing Cerebro object...
#> [14:59:21] Adding expression data (embedded)...
#> [14:59:21] Collecting available meta data...
#> [14:59:21] Extracting all meta data columns...
#> [14:59:21] Extracting dimensional reductions...
#> [14:59:21] Will export the following dimensional reductions: umap
#> [14:59:21] Extracting marker genes table...
#> [14:59:21] No trajectories to extract...
#> [14:59:21] Checking for spatial data...
#> [14:59:21] Overview of Cerebro object:
#> class: Cerebro
#> exporter package version: 4.4.1
#> experiment name: PBMC
#> organism: hg
#> date of analysis: 
#> date of export: 2026-09-07
#> number of cells: 80
#> number of genes: 230
...
#> HLA typing: none
#> Spatial data:
#> [14:59:21] Saving Cerebro object to: /tmp/nix-shell-4307-2403376108/RtmpFMRp9x/pbmc_Seurat.crb
#> [14:59:21] Done!
```
