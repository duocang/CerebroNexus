...
#> [08:58:09] Initializing Cerebro object...
#> [08:58:09] Adding expression data (embedded)...
#> [08:58:09] Collecting available meta data...
#> [08:58:09] Extracting all meta data columns...
#> [08:58:09] Extracting dimensional reductions...
#> [08:58:09] Will export the following dimensional reductions: umap
#> [08:58:09] Extracting marker genes table...
#> [08:58:09] No trajectories to extract...
#> [08:58:09] Checking for spatial data...
#> [08:58:09] Overview of Cerebro object:
#> class: Cerebro_v1.3
#> cerebroApp version: 3.0.4
#> experiment name: PBMC
#> organism: hg
#> date of analysis: 
#> date of export: 2026-08-01
#> number of cells: 80
#> number of genes: 230
...
#> HLA typing: none
#> Spatial data:
#> [08:58:09] Saving Cerebro object to: /tmp/nix-shell-4287-2328327739/RtmpI8yiDP/pbmc_Seurat.crb
#> [08:58:09] Done!
```
