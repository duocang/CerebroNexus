...
#> [09:40:45] Initializing Cerebro object...
#> [09:40:45] Adding expression data (embedded)...
#> [09:40:45] Collecting available meta data...
#> [09:40:45] Extracting all meta data columns...
#> [09:40:45] Extracting dimensional reductions...
#> [09:40:45] Will export the following dimensional reductions: umap
#> [09:40:45] Extracting marker genes table...
#> [09:40:45] No trajectories to extract...
#> [09:40:45] Checking for spatial data...
#> [09:40:45] Overview of Cerebro object:
#> class: Cerebro_v1.3
#> cerebroApp version: 3.0.6
#> experiment name: PBMC
#> organism: hg
#> date of analysis: 
#> date of export: 2026-08-03
#> number of cells: 80
#> number of genes: 230
...
#> HLA typing: none
#> Spatial data:
#> [09:40:45] Saving Cerebro object to: /tmp/nix-shell-4361-2313725300/RtmpatN2nd/pbmc_Seurat.crb
#> [09:40:45] Done!
```
