...
#> [13:14:08] Genes in GO term "cell surface" (GO:0009986) could not be retrieved, possibly due to the server not being reachable at the moment.
#> [13:14:08] Get marker genes for 2 groups in `sample`...
...
#> [13:14:08] Get marker genes for 2 groups in `seurat_clusters`...
